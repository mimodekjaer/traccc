...
track_gbts_seeding::track_gbts_seeding() : interface("GBTS Options") {
    ...
    m_desc.add_options()(
        ...
        po::value(&gbts_config.edge_making.max_Kappa)
            ->default_value(
                gbts_config.edge_making.max_Kappa),
    ...
    m_desc.add_options()(
        ...
        po::value(&gbts_config.edge_matching.cut_dphi_max)
            ->default_value(
                gbts_config.edge_matching.cut_dphi_max),
        "cut_dphi_max for edge matching [rads]");
    m_desc.add_options()(
        "cut_dcurv_max",
        po::value(
            &gbts_config.edge_matching.cut_dcurv_max)
            ->default_value(
                gbts_config.edge_matching.cut_dcurv_max),
        "cut_dcurv_max for edge matching [1/mm]");
    m_desc.add_options()(
        "cut_tau_ratio_max",
        po::value(&gbts_config.edge_matching
                       .cut_tau_ratio_max)
            ->default_value(gbts_config.edge_matching
                                .cut_tau_ratio_max),
